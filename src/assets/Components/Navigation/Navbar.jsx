...
const Navbar = () => {
    const navHover = useRef(null)
    console.log(navHover.current)
  return (
    <div className='flex w-full fixed justify-between  z-10  '>
        <div className='p-4'>
   <svg className='' xmlns="http://www.w3.org/1000/svg" width="103" height="44" fill='white' viewBox="0 0 103 44">
        ...
        <div  onMouseEnter={()=>{
        navHover.current.style.height="100%"
     }} onMouseLeave={()=>{
        navHover.current.style.height="0%"
     }} className='h-[49px]   w-53 relative '>

     <div  className=  'bg-black h-full relative  w-full flex flex-col justify-center items-end '>
        <div className='bg-white h-[1px] w-[60px] mr-7'></div>
        <div className='bg-white h-[1px] w-[40px] mt-1 mr-7'></div>
     </div>
     <div ref={navHover}  className=' bg-[#d3fd50] h-0 top-0 transition-all duration-300 ease-in-out   w-full absolute flex flex-col justify-center items-end '>
        <div className='bg-white h-[1px] w-[60px] mr-7'></div>
        <div className='bg-white h-[1px] w-[40px] mt-1 mr-7'></div>
     </div>
        </div>
